...
This term the topic of Visual Analytics Project will be based on [VAST Challenge 2022](https://vast-challenge.github.io/2022/).  The are three challenges provided. Teams are required to choose **one** of the Challenge and build a Shiny Application to answer the questions of the Challenge.
...
- Editing and publishing project proposal latest by the end of the **recess week**.
- Submission of final application, user guide, project poster and artifacts: **3rd July 2022 by 11:59pm (mid-night)**
...
- [Group 1]()
- [Group 2](https://dingyanmu.netlify.app/gp/proposal.html)
- [Group 3](https://va-group3.netlify.app/)
- [Group 4](https://isss608group4.netlify.app/proposal/proposal)
- [Group 5](https://isss608-project-group5.netlify.app/)
- [Group 6](https://isss608-group06.netlify.app/)
- [Group 7](https://isss608group7.netlify.app/proposal/proposal-v1)
- Group 8
