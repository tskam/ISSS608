...
Group 1: [Jiak Ba Buay: An Insight into the Belly of our Nation](https://isss608-g1-visualanalytics.netlify.app/)

+ Abstract:

Group 2: [VA Project](https://group2vaproject2022janterm.netlify.app/) 

+ Abstract:

Group 3: [Visual Analytics Project Proposal](https://isss608vaprojectg3.netlify.app/website/proposal/proposal)

+ Abstract:

Group 4: [Project: Visual Analytics on Singapore Merchandise Trade](https://group4-apr2022.netlify.app/)
...
Group 7: [Department Store Sales App](https://viz-analytics-t7-t2-22.netlify.app/)

+ Abstract:

Group 8: [Making Smart Real Estate Decisions using Visual Analytics](https://g8vaproject.netlify.app/)

+ Abstract:

Group 9: [O List E-Commerce Project](https://isss608team12.netlify.app/)

+ Abstract:

Group 10: [Data Visualisation Group Project: An analysis on Government Procrument](https://isss608-group10.netlify.app/)
