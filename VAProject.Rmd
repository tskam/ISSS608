...
> *Prof: For the assignment, RMarkdown should be used to prepare the answers.  For the project, on the other hands, the web application should be used by using Shiny.* 
