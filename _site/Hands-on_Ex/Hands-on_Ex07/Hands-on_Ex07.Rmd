...
.pull-left[
.large[
Write the code chunk to check, install and launch  **readr**, **sf** and **tmap** packages of R]]
...
.pull-left[
.large[
- Write the code chunk to import *SGPools_svy21.csv* into R.
]
...
library(pagedown)
pagedown::chrome_print("ISSS608-Hands-on_Ex07.html")
```
