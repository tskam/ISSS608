...
.pull-left[
[treemap](https://cran.r-project.org/web/packages/treemap/index.html) is an R package specially designed to plot treemap.  It provides many functions to customise a treemap.  
...
- the colour of the rectangle is now mapped to *GDP per capita (current US$)* by using `vColor` argument.
...
.pull-left[ 
[**d3treeR**](https://github.com/d3treeR/d3treeR) is an R htmlwidget for d3.js treemaps. It is designed to integrate seamlessly with the R treemap package.
