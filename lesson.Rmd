...
- Lesson slides in [html](lesson/Lesson03/Lesson03-Interactivity_in_Visual_Analytics.html) and in [pdf](Lesson03-Interactivity_in_Visual_Analytics.pdf) formats.
- [In-class Exercise](worksheets/intro-rmarkdown.Rmd) (Solutions are [available here](worksheets/intro-rmarkdown-solutions.Rmd))
