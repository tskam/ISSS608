...
.center[
![:scale 70%](img/image7-16.jpg)]

---
### Proportional Symbol Map
#### Avoid Junk Map https://gisanddata.maps.arcgis.com/apps/opsdashboard/index.html#/bda7594740fd40299423467b48e9ecf6 

.center[
![:scale 80%](img/image9-27.jpg)]

---
### Altertive of Proportional Symbol Map: Bricks Map

.center[
![:scale 70%](img/image7-17.jpg)]
...
.center[
![:scale 65%](img/image7-20.jpg)]

---
### Unclassified choropleth map

- **Unclassified choropleth** maps are similar to classed choropleth maps; however, unclassed choropleth maps do not have an averaged statistic towards each particular colour.  
...
.vlarge[Choosing an appropriate number of classes]

.center[
![:scale 70%](img/image7-21.jpg)]
...
.center[
![:scale 60%](img/image7-22.jpg)]

```{r echo=FALSE, eval=FALSE}
library(pagedown)
pagedown::chrome_print("ISSS608-Lesson06-Visualising-Geospatial-Data.html")
```
