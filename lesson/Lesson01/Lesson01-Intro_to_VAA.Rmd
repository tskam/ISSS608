...
???
In this big data age, data analyst tends to flooded with large amount of data.  Before she/he can build any effective model by using advanced AI/ML techniques, she/he need to first understand the data and data visualisation are one of the most commonly used method.  
...
The advantage of this approach is that it allows users to perform the analysis withoput having to learn programming.  Furthermore, data visualisation are used extensively in the modelling process. 
...
???
Although visual analytics comprises of many scientific deisplines.  It is important to note that the goal of a visual analytics is to help data analyst to discover the unexpected from data effectively.
...
???
Traditional, statistical graphics are used for visual communications.  Visual Analytics require a major paradigm shift from visual communication to visual thinking.  Data Visualisation or statistical graphics should be used to support data exploration and analysis.  Having said that, this does not mean that visual communication is longer important.  Instead, the new paradigm shift requires us to give equal focus on both visual thinking and communication. 
