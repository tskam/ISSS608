...
.center[
![:scale 70%](img/image7-4.jpg)
]

This [link](https://exts.ggplot2.tidyverse.org/gallery/) provides you a collection of **ggplot2** extensions that enhanced the basic data visualisation functionalities of **ggplot2**.  
...
.large[
A complete list of geometries supported by ggigraph and their corresponding command syntax can be found [here](https://davidgohel.github.io/ggiraph/reference/index.html).                     
]
