...
- Lesson 1 (Supplement): Choosing the Right Visualisation in [html](../lesson/Lesson01/Lesson01a-Choosing-the-Right-Visualisation.html) and [pdf](../lesson/Lesson01/Lesson01a-Choosing-the-Right-Visualisation.pdf) formats.
...
Allen M, Poggiali D, Whitaker K et al. ["Raincloud plots: a multi-platform tool for robust data visualization"](https://wellcomeopenresearch.org/articles/4-63) [version 2; peer review: 2 approved]. *Wellcome Open Res* 2021, pp. 4:63. 
